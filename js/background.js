var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-dino-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-dino-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-dino-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-dino-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari Dino?",
				description: "Get awesome Ferrari Dino HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
